...
// TODO(CHECKPOINT): Implement BusRead/BusWrite for Mmio32/Mmio64, then go back through and test to
// verify that the BusRead/BusWrite bound trickiness is still tricky.
    ...
    let expected = quote! {
        pub mod foo {
            ...
            pub trait Bus:
                ...
                ::tock_registers::Bus<<u8 as ::tock_registers::DataType>::Value>
                + sealed::Bus {}
            impl Bus for Mmio32 {}
            impl Bus for Mmio64 {}
    ...
    let expected = quote! {
        pub mod foo {
            ...
            pub trait Interface: ::tock_registers::RegisterArray<
                ...
                >
            > {}
            pub trait Bus: ::tock_registers::Bus<<u8 as ::tock_registers::DataType>::Value> +
                sealed::Bus {}
            impl Bus for Mmio32 {}
            impl Bus for Mmio64 {}
            impl sealed::Bus for Mmio32 {}
