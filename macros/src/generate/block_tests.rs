...
fn empty() {
    ...
    let expected = quote! {
        pub mod foo {
            ...
            pub trait Bus: sealed::Bus + ::tock_registers::Address {
                const BLOCK_INFO: ::tock_registers::internal::BlockInfo<0usize>;
            }
            impl Bus for Mmio32 {
                const BLOCK_INFO: ::tock_registers::internal::BlockInfo<0usize> = ::tock_registers::internal::BlockInfo::new([]);
            }
...
fn various() {
    ...
    let expected = quote! {
        pub mod foo {
            ...
            pub trait Interface: ::tock_registers::internal::core::marker::Copy {
                ...
                type array_definition: ::tock_registers::RegisterArray<
                        Element: ::tock_registers::RegisterArray<
                                Element: ::tock_registers::Register<DataType = u16> + Read
                                    + Write
                            >
                    >;
            ...
            pub trait Bus: sealed::Bus + ::tock_registers::Address + ::tock_registers::Bus<<
                    u8 as ::tock_registers::DataType>::Value
                > + ::tock_registers::Bus<<
                    u16 as ::tock_registers::DataType>::Value
                > + status::Bus + ctrl::Bus + ::tock_registers::Bus<<
                    usize as ::tock_registers::DataType>::Value
                > + ::tock_registers::Bus<<
                    u32 as ::tock_registers::DataType>::Value
                > + ::tock_registers::Bus<<u32 as ::tock_registers::DataType>::Value> {
                const BLOCK_INFO: ::tock_registers::internal::BlockInfo<10usize>;
            }
            impl Bus for Mmio32 {
                const BLOCK_INFO: ::tock_registers::internal::BlockInfo<10usize> = ::tock_registers::internal::BlockInfo::new([
                    (<Self as ::tock_registers::Bus<<
                        u8 as ::tock_registers::DataType>::Value
                    > >::PADDED_SIZE),
                    #[cfg(not(all()))]
                    0,
                    ...
                    #[cfg(not(all()))]
                    0,
                    (<ctrl::Real<Self> as ::tock_registers::Block>::SIZE * 2 * 3),
                    #[cfg(not(all()))]
                    0,
                    3,
                    #[cfg(not(all()))]
            ...
            impl sealed::Bus for Mmio64 {}
            const _: () = {
                assert!(0 == < Mmio32 as Bus > ::BLOCK_INFO.offsets[0usize], "offset mismatch");
                assert!(0 == < Mmio64 as Bus > ::BLOCK_INFO.offsets[0usize], "offset mismatch");
                ...
                assert!(2 == < Mmio32 as Bus > ::BLOCK_INFO.offsets[2usize], "offset mismatch");
                assert!(2 == < Mmio64 as Bus > ::BLOCK_INFO.offsets[2usize], "offset mismatch");
                assert!(14 == < Mmio32 as Bus > ::BLOCK_INFO.offsets[3usize], "offset mismatch");
                assert!(14 == < Mmio64 as Bus > ::BLOCK_INFO.offsets[3usize], "offset mismatch");
                assert!(15 == < Mmio32 as Bus > ::BLOCK_INFO.offsets[4usize], "offset mismatch");
                assert!(15 == < Mmio64 as Bus > ::BLOCK_INFO.offsets[4usize], "offset mismatch");
                ...
                assert!(24 == < Mmio32 as Bus > ::BLOCK_INFO.offsets[6usize], "offset mismatch");
                assert!(24 == < Mmio64 as Bus > ::BLOCK_INFO.offsets[6usize], "offset mismatch");
                assert!(28 == < Mmio32 as Bus > ::BLOCK_INFO.offsets[7usize], "offset mismatch");
                assert!(32 == < Mmio64 as Bus > ::BLOCK_INFO.offsets[7usize], "offset mismatch");
                ...
                assert!(36 == < Mmio32 as Bus > ::BLOCK_INFO.offsets[9usize], "offset mismatch");
                assert!(36 == < Mmio64 as Bus > ::BLOCK_INFO.offsets[9usize], "offset mismatch");
            };
            mod sealed {
                pub trait Bus {}
            }
            ...
            where
                ...
                :: tock_registers :: RealRegisterArray < :: tock_registers :: RealRegisterArray < real_array_definition < B > , 2 > , 3 > : :: tock_registers :: RegisterArray < Element : :: tock_registers :: RegisterArray < Element : :: tock_registers :: Register < DataType = u16 > + Read + Write > >,
                status :: Real < B > : status :: Interface,
                :: tock_registers :: RealRegisterArray < :: tock_registers :: RealRegisterArray < ctrl :: Real < B > , 2 > , 3 > : :: tock_registers :: RegisterArray < Element : :: tock_registers :: RegisterArray < Element : ctrl :: Interface > >,
                ...
                real_final_fixed_pos < B > : :: tock_registers :: Register < DataType = u32 > + Read,
            {
                ...
                fn scalar_definition(self) -> Self::scalar_definition {
                    unsafe {
                        Self::scalar_definition::new(
                            self.0.byte_add(<B as Bus>::BLOCK_INFO.offsets[0usize])
                        )
                    }
                }
                type array_definition = ::tock_registers::RealRegisterArray<
                    ::tock_registers::RealRegisterArray<real_array_definition<B>, 2>,
                    3
                >;
                fn array_definition(self) -> Self::array_definition {
                    unsafe {
                        Self::array_definition::new(
                            self.0.byte_add(<B as Bus>::BLOCK_INFO.offsets[2usize])
                        )
                    }
                }
                ...
                fn scalar_reference(self) -> Self::scalar_reference {
                    unsafe {
                        Self::scalar_reference::new(
                            self.0.byte_add(<B as Bus>::BLOCK_INFO.offsets[3usize])
                        )
                    }
                }
                type array_reference = ::tock_registers::RealRegisterArray<
                    ::tock_registers::RealRegisterArray<ctrl::Real<B>, 2>,
                    3
                >;
                fn array_reference(self) -> Self::array_reference {
                    unsafe {
                        Self::array_reference::new(
                            self.0.byte_add(<B as Bus>::BLOCK_INFO.offsets[4usize])
                        )
                    }
                }
                ...
                fn variable_size(self) -> Self::variable_size {
                    unsafe {
                        Self::variable_size::new(self.0.byte_add(<B as Bus>::BLOCK_INFO.offsets[6usize]))
                    }
                }
                type variable_pos = real_variable_pos<B>;
                fn variable_pos(self) -> Self::variable_pos {
                    unsafe {
                        Self::variable_pos::new(self.0.byte_add(<B as Bus>::BLOCK_INFO.offsets[7usize]))
                    }
                }
                ...
                fn final_fixed_pos(self) -> Self::final_fixed_pos {
                    unsafe {
                        Self::final_fixed_pos::new(
                            self.0.byte_add(<B as Bus>::BLOCK_INFO.offsets[9usize])
                        )
                    }
                }
            }
            ...
            impl<B: Bus> ::tock_registers::Block for real_scalar_definition<B> {
                type Address = B;
                const SIZE: usize = <B as ::tock_registers::Bus<<
                    u8 as ::tock_registers::DataType>::Value
                >>::PADDED_SIZE;
                unsafe fn new(address: B) -> Self {
                    Self(address)
